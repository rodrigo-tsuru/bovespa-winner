...
# Nesta análise é pego o TOP10 das PIORES ações considerando o
# "Piotroski F-score" que varia de 0 a 9.
# A intenção é analisar se essas empresas realmente tiveram performance ruim na bolsa
...
# python3 piotroski_inverted.py "{ 'year': 2015 }"
if __name__ == '__main__':
  ...
  shares.sort_values(by=['Piotroski Score', 'Cotação'], ascending=[True, False], inplace=True)
  ...
  if year != current_year():
    backtest.run_all(fundamentus.start_date(year), list(shares.index[:100]))
