...
# Graham:
# - [x] 1. raíz_quadrada_de(22.5 * VPA * LPA) => Quanto maior, melhor. Ideal > 1.5 * Preço. https://www.sunoresearch.com.br/artigos/valor-intrinseco/?utm_source=PR&utm_medium=artigo&utm_campaign=investing_05122019

# Depois de aplicados esses princípios, é calculado o valor intrínsseco para
# cada ação com base no cálculo de Benjamin Graham => raíz_quadrada_de(22.5 * VPA * LPA)
# O resultado, por sua vez, é ordenado pelo Piotrotski Score,
# caso haja empate, o Valor Intrínsseco é utilizado como critério de desempate
...
def reorder_columns(shares):
  columns = ['Ranking (Piotrotski)', 'Piotroski Score', 'Cotação', 'Preço Justo (Graham)']
...
# python3 piotroski_graham.py "{ 'year': 2015 }"
if __name__ == '__main__':
  ...
  shares.sort_values(by=['Piotroski Score', 'Preço Justo (Graham) / Cotação'], ascending=[True, True], inplace=True)
