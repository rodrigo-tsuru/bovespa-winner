...
# - [x] 8. 0 < Payout < 1
# - [x] 9. ROE > 20% https://daxinvestimentos.com/analise-fundamentalista-mais-de-200-de-rentabilidade-em-2-anos/
...
def fill_score(shares):
  ...
  shares['Bazin Score'] += ((shares['ROE']).astype(float) > 0.20).astype(int)
...
def fill_score_explanation(shares):
  ...
  shares['ROE > 20%'] = (shares['ROE']).astype(float) > 0.20
...
# python3 bazin_roe.py "{ 'year': 2015 }"
# python3 bazin_roe.py "{ 'portfolio': 'victor' }"
